    ...
    <div className="max-w-7xl mx-auto px-4 py-3">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <img
                ...
                alt="Twins get Famous for unusual hair"
                className="w-full h-40 object-cover"
              />
              <p className="mt-2 text-[14px] text-[#000] leading-relaxed">
                Twins get Famous for unusual hair
              </p>
            </div>
            ...
            <div>
              <img
                ...
                alt="10 Best Special Forces From Around the world"
                className="w-full h-40 object-cover"
              />
              <p className="mt-2 text-[14px] text-[#000] leading-relaxed">
                10 Best Special Forces From Around the world
              </p>
            </div>
            ...
            <div>
              <img
                ...
                alt="Just 33 Really Pretty Accessories For Your Spring Wardrobe"
                className="w-full h-40 object-cover"
              />
              <p className="mt-2 text-[14px] text-[#000] leading-relaxed">
                Just 33 Really Pretty Accessories For Your Spring Wardrobe
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <p className="text-lg text-[#888888]">No trending stories found.</p>
          </div>
        </div>
      </div>
    </div>
